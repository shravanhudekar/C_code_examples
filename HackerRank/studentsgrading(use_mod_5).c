...
Examples:
 ...
 |SOLUTION|
1. check every a[i] if its less than 40 or a[i]%5 (i.e. remiander is) <3             %5 will give ans(remainder): 0 1 2 3 4 0
2. then do not round off
3. else if  a[i]%5 >=3 round it off by  (5 - (a[i]%5))
4. update a[i] value with rounded off value.
5. return *a.
*/
