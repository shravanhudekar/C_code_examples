...
1. take array 'ar' of 'n' integers
2. run nested for loop 
3. add a[i] and a[j] (j>i i.e. to skip re-pairing)and check if its divisible by K
4. if divisble by k increment count
5. return count
*************************************************/
#include <assert.h>
#include <ctype.h>
